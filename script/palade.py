...
def count_plot(df,column,x_numbers=10,rotation=0,color_list=["steelblue"],ABC=False,hline_cum=0.8,ylabel_name=False):
...
def group_sum_plot(df,group_column,sum_column,x_numbers=10,rotation=0,
                   color_list=["steelblue"],ABC=False,hline_cum=0.8,ylabel_name=False):
...
def plot(label_data,value_data,cum_data,x_numbers=10,rotation=0,color_list=["steelblue"],ABC=False,hline_cum=0.8,ylabel_name=False):
    if ABC:
